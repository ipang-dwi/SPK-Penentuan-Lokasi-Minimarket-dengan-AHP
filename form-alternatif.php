                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Tambah Data Alternatif Wilayah</h3>                                    
                                </div><!-- /.box-header -->
								 <!-- form start -->
                                <form role="form" method="post" action="add-alternatif.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alternatif" id="alternatif" placeholder="Alternatif Wilayah">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Banyaknya Kompetitor</label>
                                            <input type="text" class="form-control" name="k1" id="k1" placeholder="Banyaknya Kompetitor">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputPassword1">Luas Lokasi</label>
                                            <input type="text" class="form-control" name="k2" id="k2" placeholder="Luas Lokasi">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputPassword1">Harga Sewa Tanah</label>
                                            <input type="text" class="form-control" name="k3" id="k3" placeholder="Harga Sewa Tanah">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputPassword1">Kepadatan Penduduk</label>
                                            <input type="text" class="form-control" name="k4" id="k4" placeholder="Kepadatan Penduduk">
                                        </div>
                                    </div><!-- /.box-body -->
