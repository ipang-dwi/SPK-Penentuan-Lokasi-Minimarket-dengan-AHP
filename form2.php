                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Update Data Alternatif Wilayah</h3>                                    
                                </div><!-- /.box-header -->
								<?php
									include('config.php');
                                ...
                                <form role="form" method="post" action="upd.php?id=<?php echo $_GET['id'];?>"> 
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Alternatif Wilayah</label>
                                            <input type="text" class="form-control" id="alternatif" name="alternatif" value="<?php echo $row["alternatif"];?>" placeholder="Alternatif Wilayah">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Banyaknya Kompetitor</label>
                                            <input type="text" class="form-control" id="k1" name="k1" value="<?php echo $row["k1"];?>" placeholder="Banyaknya Kompetitor">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputPassword1">Luas Lokasi</label>
                                            <input type="text" class="form-control" id="k2" name="k2" value="<?php echo $row["k2"];?>" placeholder="Luas Lokasi">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputPassword1">Harga Sewa Tanah</label>
                                            <input type="text" class="form-control" id="k3" name="k3" value="<?php echo $row["k3"];?>" placeholder="Harga Sewa Tanah">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputPassword1">Kepadatan Penduduk</label>
                                            <input type="text" class="form-control" id="k4" name="k4" value="<?php echo $row["k4"];?>" placeholder="Kepadatan Penduduk">
                                        </div>
                                    </div><!-- /.box-body -->
